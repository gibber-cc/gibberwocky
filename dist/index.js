...
module.exports = function (Gibber) {
  ...
  var Arp = function Arp() {
    ...
    _arp = function arp() {
      ...
      _arp.transpose = notes.transpose.bind(notes);
      _arp.reset = notes.reset.bind(notes);
      _arp.reverse = notes.reverse.bind(notes);
      _arp.rotate = notes.rotate.bind(notes);
    ...
    outputMessages: function outputMessages() {
      ...
      this.msgs.forEach(function (msg) {
        if (Array.isArray(msg)) {
          ...
          if (msg !== 0) {
            console.log(msg.split(' ')[2], _this2.currentBeat, msg);
          }
          if (msg !== 0 && parseInt(msg.split(' ')[2]) == _this2.currentBeat) {
...
var Marker = {
  ...
  process: function process(code, position, codemirror, track) {
    ...
    try {
      for (var _iterator = tree[Symbol.iterator](), _step2; !(_iteratorNormalCompletion = (_step2 = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    CallExpression: function CallExpression(expressionNode, codemirror, track) {
      ...
      switch (callDepths[depthOfCall]) {
        ...
        case 'THIS.METHOD[ 0 ].VALUES.REVERSE.SEQ':
          ...
          if (expressionNode.expression.callee.object.object.type !== 'ThisExpression') {
            var obj = expressionNode.expression.callee.object;
  ...
  _markPattern: {
    ...
    ArrayExpression: function ArrayExpression(patternNode, containerNode, components, cm, track) {
      ...
      try {
        ...
        for (var _iterator2 = patternNode.elements[Symbol.iterator](), _step3; !(_iteratorNormalCompletion2 = (_step3 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          _loop();
        }
      } catch (err) {
...
},{"./utility.js":22,"acorn":24}],5:[function(require,module,exports){
'use strict';
...
},{"../node_modules/codemirror/addon/edit/closebrackets.js":27,"../node_modules/codemirror/addon/edit/matchbrackets.js":28,"../node_modules/codemirror/addon/hint/javascript-hint.js":29,"../node_modules/codemirror/addon/hint/show-hint.js":30,"../node_modules/codemirror/mode/javascript/javascript.js":32,"./animationScheduler.js":1,"./codeMarkup.js":4,"./lomView.js":13,"./tabs-standalone.microlib-latest.js":19,"codemirror":31}],7:[function(require,module,exports){
'use strict';
...
module.exports = function (Gibber) {
  ...
  var Gen = {
    ...
    assignParamID: function assignParamID(id) {
      this.paramID = id;
...
},{"./arp.js":2,"./clock.js":3,"./communication.js":5,"./environment.js":6,"./euclidean.js":7,"./example.js":8,"./gen.js":9,"./live.js":12,"./pattern.js":14,"./score.js":16,"./seq.js":17,"./steps.js":18,"./theory.js":20,"./track.js":21,"./utility.js":22}],11:[function(require,module,exports){
'use strict';
...
},{"./gibber.js":10,"babel-polyfill":25}],12:[function(require,module,exports){
'use strict';
...
module.exports = function (Gibber) {
  ...
  var Live = {
    ...
    processTrack: function processTrack(spec, idx) {
      ...
      try {
        for (var _iterator2 = track.devices[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
},{"./vanillatree.js":23}],14:[function(require,module,exports){
'use strict';
        ...
        this.values.filters.push(function (args) {
          ...
          if (typeof chord === 'string') {
            ...
            for (var _i = 0; _i < chord.length; _i++) {
              var note = Gibber.Theory.Note.convertToMIDI(chord[_i]);
              out.push(note);
            }
          }
      ...
      if (shouldExecute) {
        ...
        if (value !== this) {
          ...
          if (this.externalMessages[this.key] !== undefined) {
            ...
            var msg = this.externalMessages[this.key](value, beat, beatOffset, this.trackID);
...
},{"big.js":26}],18:[function(require,module,exports){
'use strict';
      ...
      Object.assign(track, {
        ...
        chord: function chord(_chord) {
          ...
          if (typeof _chord === 'string') {
            var chordObj = Gibber.Theory.Chord.create(_chord);

            _chord = chordObj.notes;
            console.log('chord', _chord);
            for (var i = 0; i < _chord.length; i++) {
              var note = _chord[i]; // Gibber.Theory.Note.convertToMIDI( chord[i] )
              this.note(_chord[i]); //msg.push( `${Gibber.Live.id} note ${note} ${velocity} ${duration}`.trimRight() )
            }
          } else {
            for (var _i = 0; _i < _chord.length; _i++) {
              var _note = Gibber.Theory.Note.convertToMIDI(_chord[_i]);
              this.note(_chord[_i]);
...
},{"core-js/fn/regexp/escape":33,"core-js/shim":326,"regenerator-runtime/runtime":328}],26:[function(require,module,exports){
...
},{"../../lib/codemirror":31}],28:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":31}],29:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":31}],30:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":31}],31:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
